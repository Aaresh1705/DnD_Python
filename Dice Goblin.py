...
import numpy as np
import sys, os
from dices import Constant, Standard_dice, Non_standard_dice
            ...
            try:
                ...
                for i in range(dice_amount):
                    if dice_sides in standard_dices:
                        dices.append(Standard_dice(dice_sides))
                    else:
                        dices.append(Non_standard_dice(dice_sides))
            except:
                return False, []
